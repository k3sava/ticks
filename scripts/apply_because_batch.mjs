...
const BECAUSE_BATCH = {
  ...
  'ai-in-drug-discovery-first-ai-designed-drug-trials':
    "Pre-2025 drug discovery had required years of wet-lab experimentation. The first AI-designed-drug clinical trials (~2025, with Insilico Medicine, Recursion, BenevolentAI) demonstrated that AI could identify drug candidates, predict their properties, and shepherd them into clinical trials in dramatically compressed timelines. The first sustained-scale AI-driven drug discovery pipeline. Combined with AlphaFold 3's protein-structure predictions, modern pharmacology is being remade. Whether AI-discovered drugs significantly improve clinical outcomes remains under evaluation.",
