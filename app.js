...
const HERO_OPENINGS = [
  ...
  { h: "Most of history is <em>nothing happening</em>.",
    sub: "Then a constraint dissolves and a hundred things become possible.",
    sub2: "We collected 2,648 of those moments. Pick one." },
  { h: "Every modern thing is <em>downstream</em> of a sentence.",
    sub: "Recursive language gave us symbolic thought. Symbolic thought gave us everything else.",
    sub2: "Walk forward from there, or backward from your phone." },
  { h: "What had to <em>dissolve</em> before this?",
    sub: "Pick anything modern. The chain backward is shorter than you think.",
    sub2: "Sometimes seven steps. Sometimes seventy thousand years." },
  { h: "History is a <em>graph</em>, not a list.",
    sub: "Each tick has parents (what came before) and children (what came after).",
    sub2: "The edges are where the meaning lives." },
];
